# Generated by Django 2.0.3 on 2018-11-18 21:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='farmerapp.Inventory')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('minimum_capacity', models.DecimalField(decimal_places=0, max_digits=9)),
                ('max_capacity', models.DecimalField(decimal_places=0, max_digits=9)),
            ],
        ),
        migrations.CreateModel(
            name='UserCategory',
